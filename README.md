...
| Nested Block Depth (NBD) | Complexity | 1..N | The number of the maximum depth of nested block. If there is no nested block, the depth equals to 1. | High value: A method that is complex. Harder to test all the cases of a method. |
